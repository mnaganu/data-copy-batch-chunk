...
public class CopyToSampleRepositoryImplTest {
    ...
    void selectByOffset_検索結果0件() {
        //offset が 0よりも小さい
        SelectModel<SampleModel> selectModel = copyToSampleRepositoryImpl.selectByOffset(-1, 1);
        ...
        //limit が 1よりも小さい
        selectModel = copyToSampleRepositoryImpl.selectByOffset(0, 0);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //offset が 0よりも小さい　
        //limit が 1よりも小さい
        selectModel = copyToSampleRepositoryImpl.selectByOffset(-1, 0);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //テーブルを作り直してデータを全て消す。
        createTable();
        selectModel = copyToSampleRepositoryImpl.selectByOffset(1, 10);
        assertThat(selectModel.getList().isEmpty()).isTrue();
    ...
    void selectByOffset_検索結果1件() {
        //先頭の1件
        SelectModel<SampleModel> selectModel = copyToSampleRepositoryImpl.selectByOffset(0, 1);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        ...
        //中間の1件
        selectModel = copyToSampleRepositoryImpl.selectByOffset(1, 1);
        assertThat(selectModel.getOffset()).isEqualTo(1);
        assertThat(selectModel.getLimit()).isEqualTo(1);
        assertThat(selectModel.getTotal()).isEqualTo(3);
        ...
        //最後の1件
        selectModel = copyToSampleRepositoryImpl.selectByOffset(2, 10);
    ...
    void selectByOffset_検索結果が複数件() {
        SelectModel<SampleModel> selectModel = copyToSampleRepositoryImpl.selectByOffset(0, 10);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(10);
        assertThat(selectModel.getTotal()).isEqualTo(3);
    ...
    void selectByOffsetId_検索結果0件() {
        //offset が 0よりも小さい
        SelectModel<SampleModel> selectModel = copyToSampleRepositoryImpl.selectByOffsetId(-1, -1, 1);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //limit が 1よりも小さい
        selectModel = copyToSampleRepositoryImpl.selectByOffsetId(-1,0, 0);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //offset が 0よりも小さい　
        //limit が 1よりも小さい
        selectModel = copyToSampleRepositoryImpl.selectByOffsetId(-1,-1, 0);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(0);
        assertThat(selectModel.getTotal()).isEqualTo(0);
        ...
        //テーブルを作り直してデータを全て消す。
        createTable();
        selectModel = copyToSampleRepositoryImpl.selectByOffsetId(-1,1, 10);
        assertThat(selectModel.getList().isEmpty()).isTrue();
        assertThat(selectModel.getOffset()).isEqualTo(1);
        assertThat(selectModel.getLimit()).isEqualTo(10);
        assertThat(selectModel.getTotal()).isEqualTo(0);
    ...
    void selectByOffsetId_検索結果1件() {
        //先頭の1件
        SelectModel<SampleModel> selectModel = copyToSampleRepositoryImpl.selectByOffsetId(0, 0, 1);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(1);
        assertThat(selectModel.getTotal()).isEqualTo(3);
        ...
        //中間の1件
        selectModel = copyToSampleRepositoryImpl.selectByOffsetId(1, 0, 1);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(1);
        ...
        //最後の1件
        selectModel = copyToSampleRepositoryImpl.selectByOffsetId(2, 0, 10);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(10);
    ...
    void selectByOffsetId_検索結果が複数件() {
        SelectModel<SampleModel> selectModel = copyToSampleRepositoryImpl.selectByOffsetId(0, 0, 10);
        assertThat(selectModel.getOffset()).isEqualTo(0);
        assertThat(selectModel.getLimit()).isEqualTo(10);
        assertThat(selectModel.getTotal()).isEqualTo(3);
